...
<tr>
            ...
            <td>
          <img src= "storage/<?php echo $post['image']?>" style="width:100px;height:100px"/>
            ...
            <td>
         <a href="{{route('categories.edit',$post->category->id)}}"> {{$post->category->title}}</a>
           ...
           @method('DELETE')
            ...
            <input type="submit"   class="btn btn-danger  mr-2" value="{{$post->trashed()?'Delete':'Trash'}} "/>
