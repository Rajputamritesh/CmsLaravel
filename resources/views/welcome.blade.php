              ...
              <div class="row gap-y">
                ...
                <div class="col-md-6">
                  <div class="card border hover-shadow-6 mb-6 d-block">
                    <a href="{{route('blog.show',$post->id)}}"><img  style="with:350px;height:350px" class="card-img-top" src="storage/<?php echo $post->image?>" alt="Card image cap"></a>
                    <div class="p-6 text-center">
                      <p><a class="small-5 text-lighter text-uppercase ls-2 fw-400" href="#">{{$post->category->title}}</a></p>
            ...
            <div class="col-md-4 col-xl-3">
              <div class="sidebar px-4 py-md-0">
                ...
                <div class="row link-color-default fs-14 lh-24">
                  ...
                  <div class="col-6"><a href="#">{{$x->title}}</a></div>
                  @endforeach
                </div>
